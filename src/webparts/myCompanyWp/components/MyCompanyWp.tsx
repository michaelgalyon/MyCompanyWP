...
import styles from './MyCompanyWp.module.scss';
import { IMyCompanyWpProps } from './IMyCompanyWpProps';
...
export default class MyCompanyWp extends React.Component<IMyCompanyWpProps, void> {
  public render(): React.ReactElement<IMyCompanyWpProps> {
    ...
    return (
      <div className={"WebPartContainer ms-Grid ms-bgColor-white"}>
        <div className={styles.myCompanyWp}>
